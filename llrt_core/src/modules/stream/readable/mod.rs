...
use super::{
    promise_rejected_with, promise_resolved_with, set_promise_is_handled_to_true,
    writable::WritableStream, Null, ObjectExt, QueuingStrategy, ReadableWritablePair,
...
impl<'js> ReadableStream<'js> {
    ...
    async fn pipe_to(
        &self,
        _destination: Class<'js, WritableStream<'js>>,
        _options: Option<StreamPipeOptions<'js>>,
    ) -> Result<()> {
        unimplemented!()
    }
